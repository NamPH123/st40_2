...
public class ActivityLanguageBindingImpl extends ActivityLanguageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.linear_language, 1);
        sViewsWithIds.put(R.id.appCompatTextView3, 2);
        sViewsWithIds.put(R.id.imvDone, 3);
        sViewsWithIds.put(R.id.rcl_language, 4);
    }
    // views
    @NonNull
