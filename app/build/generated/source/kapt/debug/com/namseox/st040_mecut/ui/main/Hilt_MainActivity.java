 ...
 */
public abstract class Hilt_MainActivity<V extends ViewDataBinding> extends AbsBaseActivity<V> implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainActivity(boolean fragment) {
    super(fragment);
    _initHiltInternal();
  }
