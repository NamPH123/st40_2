...
import com.namseox.st040_mecut.view.customview.customimage.StickerConstant.ellipsis

class TextSticker @JvmOverloads constructor(private val context: Context, drawable: Drawable? = null, filePath: String? = null) : Sticker() {
    ...
    init {
        ...
        if (drawable == null) {
//            this.drawable = ContextCompat.getDrawable(context, R.drawable.bg_emoji_transparent)!!
        }
        ...
        if (targetTextSizePixels == minTextSizePixels && targetTextHeightPixels > heightPixels) {
            ...
            if (staticLayout.lineCount > 0) {
                ...
                if (lastLine >= 0) {
                    ...
                    val ellipseWidth = textPaintCopy.measureText(ellipsis)
                    ...
                    setText(text.subSequence(0, endOffset).toString() + ellipsis)
                }
            }
        }
