...
import static ir.kotlin.kavehcolorpicker.PixelConversionExtensionFunctionKt.dp;
...
public class OptiMergeVideo extends View {
    ...
    public OptiMergeVideo(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OptiMergeVideo(@NonNull Context context) {
        this(context, null, 0);
    }

    public OptiMergeVideo(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
        drawableLeft = Objects.requireNonNull(context.getDrawable(R.drawable.ic_left_cut_video));
        drawableRight = Objects.requireNonNull(context.getDrawable(R.drawable.ic_right_cut_video));
    }
...
//                }
                            ...
                            if (checkRight) {
                                ...
                                if (checkLine) {
                                    if (event.getX() > 0+ dp(8f) && event.getX() < getMeasuredWidth()-dp(8) ) {
                                        ...
                                        listener.onChangeLine(leftLine);
                                    }
                                }
                            }
                        }
    ...
    public void changeLine(float i) {
        if(i<leftHandle){
            ...
            if(i>rightHandle-dp(20f)){
                leftLine = (long) (rightHandle-dp(20f));
                checkUpdate = true;
                invalidate();
            }else {
                leftLine = (long) i;
