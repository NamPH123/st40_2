...
public class OptiTimeLineViewMerge extends View {
    ...
    public OptiTimeLineViewMerge(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public OptiTimeLineViewMerge(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
...
//                        Bitmap bitmap = mBitmapList.get(i);
                ...
                while (bitmapOut != null) {
                    canvas.drawBitmap(bitmapOut, x + getContext().getResources().getDimensionPixelOffset(R.dimen._dp2), getContext().getResources().getDimensionPixelOffset(R.dimen._dp2), purplePaint);
                    x = x + bitmapOut.getWidth();
                    a++;
                    bitmapOut = mBitmapList.get(a);
                }
